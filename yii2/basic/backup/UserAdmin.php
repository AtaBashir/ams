...
class UserAdmin extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['usr_id', 'usr_name', 'usr_pass', 'usr_email', 'usr_secq', 'usr_seca'], 'required'],
            [['usr_is_teacher', 'usr_is_admin', 'usr_is_su', 'usr_active'], 'boolean'],
        	[['usr_type_id'], 'integer'],        		
            [['usr_id'], 'string', 'max' => 16],
            [['usr_name', 'usr_secq', 'usr_seca'], 'string', 'max' => 50],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'usr_pass' => 'Password',
            'usr_email' => 'Email',
            'usr_secq' => 'Security Question',
            'usr_seca' => 'Security Answer',
   ...
   * {
   * 	return CPasswordHelper::verifyPassword( $password, $this->usr_pass );
   * }
    **/
